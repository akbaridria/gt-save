<template>
  ...
  <div v-show="open" class="absolute right-0 z-10 mt-2 w-56 h-56 overflow-auto no-scrollbar border border-netral-300 origin-top-right rounded-md" style="background: rgba(28, 28, 28, 0.2); backdrop-filter: blur(8px);" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
    <div class="py-1" role="none">
      <a v-for="(item, index) in listChains" :key="index" href="#" class="group flex gap-3 px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">
