    ...
    <div class="grid lg:grid-cols-2 xl:grid-cols-2 gap-4">
      <div class="border border-netral-300 rounded p-[1rem] md:p-[2rem] lg:p-[2.5rem] xl:p-[3rem] grid gap-4 justify-center text-center max-w-full">
        ...
        <div class="grid items-center">
          <input class="bg-transparent outline-0 text-center text-[2rem] lg:text-[3rem] xl:text-[4rem] w-full" placeholder="0.0" type="number" inputmode="decimal" min="0" v-model="amountDeposit">
        </div>
        <div>
          Balance: 0.1 Max
        </div>
        <div class="flex justify-center">
          <div class="bg-primary-100 rounded-xl px-[1.25rem] py-[0.5rem] lg:py-[0.75rem] xl:py-[0.875rem] text-netral-500">
            Approve use of USDC
          </div>
        </div>
      </div>
